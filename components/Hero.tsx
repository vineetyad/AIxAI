...
export const Hero: React.FC = () => {
  return (
    <section className="relative flex flex-col items-center justify-center pt-28 pb-10 text-center min-h-[85vh]">
      ...
      {/* Main Headline */}
      <h1 className="max-w-5xl text-5xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white via-white to-white/40 sm:text-4xl md:text-7xl lg:text-8xl mb-8 drop-shadow-2xl">
